...
배포 사이트: https://carbona-lemon.vercel.app/
...
프로젝트는 Vercel과 Neon PostgreSQL을 이용해 배포했습니다.

- 애플리케이션 배포: Vercel
- 데이터베이스: Neon PostgreSQL
- 배포 URL: https://carbona-lemon.vercel.app/

Vercel에는 Neon에서 발급한 PostgreSQL connection string을 `DATABASE_URL` 환경변수로 등록했습니다.

```txt
DATABASE_URL=postgresql://...
```

Vercel 배포 시 Next.js 빌드는 webpack 기준으로 실행했습니다.
