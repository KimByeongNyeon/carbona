...
const serviceFeatures = [
  {
    icon: Database,
    title: "활동 데이터 입력",
    description: "전기, 원소재, 운송 데이터를 수동 입력하거나 Excel로 가져옵니다.",
  },
  {
    icon: Leaf,
    title: "배출계수 기반 계산",
    description: "활동량과 배출계수를 연결해 kgCO2e 기준 배출량을 자동 계산합니다.",
  },
  {
    icon: BarChart3,
    title: "대시보드 추적",
    description: "월별 추이, 활동 유형별 비중, 전월 대비 변화를 한눈에 확인합니다.",
  },
  {
    icon: Target,
    title: "목표 관리",
    description: "월간 목표를 설정하고 초과, 주의, 정상 상태를 빠르게 판단합니다.",
  },
  {
    icon: FileDown,
    title: "PDF 보고서",
    description: "선택한 기간과 월 기준의 대시보드 데이터를 보고서로 내보냅니다.",
  },
  {
    ...
    <main className="min-h-screen bg-white text-slate-950">
      ...
      <section className="mx-auto grid min-h-[calc(100vh-92px)] w-full max-w-7xl content-center gap-14 px-5 pb-16 pt-10 sm:px-8 lg:px-10">
        <div className="max-w-5xl">
          ...
          <h1 className="mt-8 max-w-5xl text-5xl font-extrabold leading-tight tracking-normal text-slate-950 sm:text-6xl lg:text-7xl">
            제품의 탄소 배출을
            <br />
            계산에서 보고까지 연결하세요.
          </h1>
          <p className="mt-8 max-w-3xl text-xl font-medium leading-8 text-slate-600 sm:text-2xl sm:leading-9">
      ...
      <section id="pcf" className="bg-slate-50 px-5 py-24 sm:px-8 lg:px-10">
        <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          ...
          <div className="space-y-6 text-lg font-medium leading-8 text-slate-600">
            <p>
              PCF(Product Carbon Footprint)는 제품의 원재료, 생산, 운송 등
              활동 과정에서 발생한 온실가스 배출량을 제품 단위로 계산한
              값입니다.
            </p>
            <p>
      ...
      <section id="service" className="bg-slate-950 px-5 py-24 text-white sm:px-8 lg:px-10">
        <div className="mx-auto max-w-7xl">
